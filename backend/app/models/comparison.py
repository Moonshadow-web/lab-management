...
class ComparisonPlan(Base):
    ...
    qual_meta_json: Mapped[str] = mapped_column(Text, default="{}")  # 定性比对：检测系统信息。新结构 {项目名: {instrument_id(字符串): {method, reagent_manufacturer, reagent_lot}}}；兼容旧结构 {instrument_id: {...}}（按项目复制）

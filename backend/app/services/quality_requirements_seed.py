...
WST403_ITEMS: list[dict[str, Any]] = [
    ...
    # 血清保护条目：下列「（尿液）」同名项经 contains_same_item 会回拉血清查询，
    # 若血清无精确条目会被尿液目标覆盖（如 磷→7.7%）。补精确血清条目使其优先命中。
    {"item_name": "磷",       "cv": "4.0%", "bias": "3.0%", "tea": "10.0%"},
    {"item_name": "总钙",     "cv": "2.0%", "bias": "2.0%", "tea": "5.0%"},
...
BJHR_ITEMS: list[dict[str, Any]] = [
    ...
    {"category": "136","item_name": "乙肝病毒表面抗体(HBsAb)",  "cv": "", "tea": "与预期结果一致"},
    {"category": "137","item_name": "乙肝病毒核心抗体(HBcAb)",  "cv": "", "tea": "与预期结果一致"},
    {"category": "138","item_name": "乙肝病毒e抗原(HBeAg)",     "cv": "", "tea": "与预期结果一致"},
    {"category": "139","item_name": "乙肝病毒e抗体(HBeAb)",     "cv": "", "tea": "与预期结果一致"},
    {"category": "140","item_name": "丙型肝炎抗体(抗-HCV)",    "cv": "", "tea": "与预期结果一致"},
    {"category": "141","item_name": "甲型肝炎病毒IgM抗体(抗-HAV IgM)","cv": "", "tea": "与预期结果一致"},
    {"category": "142","item_name": "乙型肝炎病毒核心IgM抗体(抗-HBc IgM)","cv": "", "tea": "与预期结果一致"},
    {"category": "143","item_name": "戊型肝炎病毒IgM抗体(抗-HEV IgM)","cv": "", "tea": "与预期结果一致"},
    {"category": "144","item_name": "人免疫缺陷病毒抗体(抗-HIV)","cv": "", "tea": "与预期结果一致"},
    {"category": "145","item_name": "梅毒螺旋体抗体(抗-TP)",   "cv": "", "tea": "与预期结果一致"},
    {"category": "146","item_name": "巨细胞病毒IgM抗体(CMV-IgM)","cv": "", "tea": "与预期结果一致"},
    {"category": "147","item_name": "巨细胞病毒IgG抗体(CMV-IgG)","cv": "", "tea": "与预期结果一致"},
    {"category": "148","item_name": "Ⅰ型单纯疱疹病毒IgM抗体(HSV-Ⅰ-IgM)","cv": "", "tea": "与预期结果一致"},
    {"category": "149","item_name": "Ⅰ型单纯疱疹病毒IgG抗体(HSV-Ⅰ-IgG)","cv": "", "tea": "与预期结果一致"},
    {"category": "150","item_name": "Ⅱ型单纯疱疹病毒IgM抗体(HSV-Ⅱ-IgM)","cv": "", "tea": "与预期结果一致"},
    {"category": "151","item_name": "Ⅱ型单纯疱疹病毒IgG抗体(HSV-Ⅱ-IgG)","cv": "", "tea": "与预期结果一致"},
    {"category": "152","item_name": "弓形虫IgM抗体(TOX-IgM)", "cv": "", "tea": "与预期结果一致"},
    {"category": "153","item_name": "弓形虫IgG抗体(TOX-IgG)", "cv": "", "tea": "与预期结果一致"},
    {"category": "154","item_name": "风疹病毒IgM抗体(RV-IgM)","cv": "", "tea": "与预期结果一致"},
    {"category": "155","item_name": "风疹病毒IgG抗体(RV-IgG)","cv": "", "tea": "与预期结果一致"},
    # 激素/特殊

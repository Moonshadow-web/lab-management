<template>
  <div class="cmp-page">
    <div class="toolbar">
      <el-button :icon="EditPen" @click="openGroupEdit" :disabled="!selectedGroup" v-if="canEdit">编辑分组</el-button>
      <el-button type="danger" :icon="Delete" @click="onDeleteGroup" :disabled="!selectedGroup" v-if="canEdit">删除分组</el-button>
      <el-button type="primary" :icon="Plus" @click="openGroupCreate" v-if="canCreate">新建分组</el-button>
      ...
      <div style="flex:1" />
      <el-button type="success" :icon="Plus" @click="openPlanCreate" :disabled="!selectedGroup" v-if="canCreate">新建计划</el-button>
    </div>
...
const canCreate = computed(() => perm.canWrite(auth.myRoles, 'comparison-create'))

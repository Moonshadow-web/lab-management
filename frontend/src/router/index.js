...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'iso15189', name: 'iso15189', component: () => import('../views/iso15189/Iso15189Hub.vue'), meta: { title: '15189专项', moduleKey: 'iso15189' } },

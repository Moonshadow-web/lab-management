...
CRITERIA = [
    ...
    # ── 2026-09-18 补充：定性/感染性标志物与激素类（卫健委 EQA 对感染性标志物只做定性评价，
    #    无百分比标准，按科室口径统一给 15%；血管紧张素II 参照 NCCL 肾素 ±25%÷2 = 12.5%）──
    ("血管紧张素", 12.5, "relative", "科室规定：允许相对偏倚 12.5%"),
    ("乙型肝炎病毒", 15, "relative", "科室规定：允许相对偏倚 15%"),
    ("丙型肝炎病毒", 15, "relative", "科室规定：允许相对偏倚 15%"),
    ("戊型肝炎病毒", 15, "relative", "科室规定：允许相对偏倚 15%"),
    ("甲型肝炎病毒", 15, "relative", "科室规定：允许相对偏倚 15%"),
    ("梅毒螺旋体", 15, "relative", "科室规定：允许相对偏倚 15%"),
    ("人类免疫缺陷病毒", 15, "relative", "科室规定：允许相对偏倚 15%"),
    ("风疹病毒", 15, "relative", "科室规定：允许相对偏倚 15%"),
    ("巨细胞病毒", 15, "relative", "科室规定：允许相对偏倚 15%"),
    ("弓形虫", 15, "relative", "科室规定：允许相对偏倚 15%"),
    ("单纯疱疹", 15, "relative", "科室规定：允许相对偏倚 15%"),
    ("结核分枝杆菌", 15, "relative", "科室规定：允许相对偏倚 15%"),
]

# 不参与批间验证的项目（关键词）
EXCLUDE = ["特异性生长因子", "抗凝血酶", "狼疮抗凝物"]
